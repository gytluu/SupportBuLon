...
local colorSettings =
{
    ...
    ["MainButtons"] = { 
        ["BorderColor"] = Color3.fromRGB(113, 128, 147),
        ["BackgroundColor"] = Color3.fromRGB(0, 128, 63), -- Màu xanh lá cây tối hơn
        ["TextColor"] = Color3.fromRGB(220, 221, 225)
    },
    ['Code'] = {
...
HeaderTextLabel.Text = "Turtle Spy | elgato"
HeaderTextLabel.TextColor3 = Color3.fromRGB(0, 255, 255)
